...
## Purpose
Import real game screenshot images into the training dataset structure with automated label parsing and random distribution across train/validation/test splits.
