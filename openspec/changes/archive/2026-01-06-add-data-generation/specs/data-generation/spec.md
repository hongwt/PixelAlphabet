...
## Overview
Generate synthetic training data by overlaying alphanumeric characters onto game skill icon backgrounds, creating realistic samples for character recognition model training.
